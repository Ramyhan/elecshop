		...
		<div style="display: flex;justify-content: space-around;">
			<nav aria-label="Page navigation example">
			  ...
			  <c:if test="${noticeMap.page.prev == true}">
			    <li class="page-item">
			      <a class="page-num page-link" href="${noticeMap.page.startPage - 1}" aria-label="Previous">
			        <span aria-hidden="true"><i class="fa fa-angle-double-left"></i></span>
			      </a>
			    </li>
			  </c:if>
			    <c:forEach begin="${noticeMap.page.startPage }" end="${noticeMap.page.endPage}" var="v">
			    	<li class="page-item"><a class="page-num page-link ${(noticeMap.page.criteria.pageNum == v) ? 'Active' : ''}" href="${v}">${v}</a></li>
			    </c:forEach>
			    <c:if test="${noticeMap.page.next == true}">
				    <li class="page-item">
				      <a class="page-num page-link" href="${noticeMap.page.endPage + 1}" aria-label="Next">
