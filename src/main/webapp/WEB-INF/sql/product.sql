...
VALUES (SEQ_OPTION.NEXTVAL, 5, '256G', 50000, 1);
INSERT INTO TBL_PRODUCT_OPTION(ONO, PNO, ONAME, OPRICE, OTYPE)
VALUES (SEQ_OPTION.NEXTVAL, 5, '512G', 50000, 1);
INSERT INTO TBL_PRODUCT_OPTION(ONO, PNO, ONAME, OPRICE, OTYPE)
VALUES (SEQ_OPTION.NEXTVAL, 5, '1T', 120000, 1);

INSERT INTO TBL_PRODUCT_OPTION(ONO, PNO, ONAME, OPRICE, OTYPE)
VALUES (SEQ_OPTION.NEXTVAL, 5, 'DIVKS5LIV', 50000, 2);
INSERT INTO TBL_PRODUCT_OPTION(ONO, PNO, ONAME, OPRICE, OTYPE)
VALUES (SEQ_OPTION.NEXTVAL, 5, '1111111', 100000, 2);
INSERT INTO TBL_PRODUCT_OPTION(ONO, PNO, ONAME, OPRICE, OTYPE)
VALUES (SEQ_OPTION.NEXTVAL, 5, '2222222', 150000, 2);

INSERT INTO TBL_PRODUCT_OPTION(ONO, PNO, ONAME, OPRICE, OTYPE)
VALUES (SEQ_OPTION.NEXTVAL, 5, 'BLACK', 150000, 3);
INSERT INTO TBL_PRODUCT_OPTION(ONO, PNO, ONAME, OPRICE, OTYPE)
